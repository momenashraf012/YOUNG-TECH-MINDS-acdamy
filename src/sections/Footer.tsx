      ...
      <Container>
        <div className="grid grid-cols-[1.4fr_1fr_1fr_1fr] gap-8 pb-9 border-b border-white/12 max-[820px]:grid-cols-2 max-[520px]:grid-cols-1">
          <div>
            <Logo
              variant="horizontal"
              markSrc="/assets/logos/brand-mark.png"
              height={32}
              reversed
            />
            <p className={cn(font, 'text-sm leading-[1.65] text-on-dark-muted mt-4 max-w-[280px]')}>
              {t.footer.blurb}
            </p>
          ...
          {t.footer.cols.map((col, i) => (
            <div key={i}>
              <div
                className={cn(
                  font,
                  'text-[13px] font-bold tracking-[0.04em] text-white mb-3.5',
        ...
        <div className="flex justify-between items-center flex-wrap gap-3 pt-[22px]">
          <span className="font-en text-[13px] text-on-dark-muted">
            © 2026 Young Tech Minds. {t.footer.rights}
          </span>
